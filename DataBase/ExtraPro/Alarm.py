...
def RingerNow(time):
    ...
    extracted_time = open('C:\\Users\\pc\\Desktop\\AI\\How To Make Jarvis\\Data.txt','rt')
    time = extracted_time.read()
    Time = str(time)

    delete_time = open("C:\\Users\\pc\\Desktop\\AI\\How To Make Jarvis\\Data.txt",'r+')
    ...
    while True:
        ...
        if current_time == Alarm_Time:
            ...
            playsound("C:\\Users\\pc\\Desktop\\AI\\How To Make Jarvis\\DataBase\\Sounds\\1.mp3")
